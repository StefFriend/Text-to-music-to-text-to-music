...
parser.add_argument('-instrument', type=str, required=True, help='Instrument type.')
...
filename = f"infinitystem/iterations/{args.instrument}_{args.iteration}.wav"  # Ensure 'wav' directory exists
